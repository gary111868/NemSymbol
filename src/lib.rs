...
#[derive(Debug)]
pub struct NemSymbolProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NemSymbolProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NemSymbol processing");
    
    let mut processor = NemSymbolProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NemSymbolProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NemSymbolProcessor::new(false);
